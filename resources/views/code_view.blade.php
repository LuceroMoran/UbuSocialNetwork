  ...
  <div class="main container-fluid col-md-8 col-xs-12 col-sm-12">
    ...
    <div class="media">
      <div class="media-body">
        <h3 class="media-heading" ng-repeat="data in codigodata" align="center">{{data.titulo}}</h3>
      <h5>Sintaxis: {{data.sintaxis}} <span class="glyphicon glyphicon-tags"></span></h5>
      <div class="row">
        <!--
      <pre id="code-layer">
        ...
        <div class="media-body">
          ...
          <div class="col-md-8">
            ...
            <div class="input-group" ng-repeat="info in personalInfo" >
              ...
              <button class="btn btn-info" ng-click="sendComentario()">Comentar</button>
              </span>
            </div>
          </div>
        </div>
